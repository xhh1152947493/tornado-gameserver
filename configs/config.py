...
define("wechatPayAESKey", default="asfxwd8i2b1234P1314UZZhYdAr7OCI6520ge2kfcXI", help="微信道具直购回调AES解密key")
define("appSignKey", default="2024CFD4-B5B1-4468-9ACE-60C3C6667B22", help="客户端http请求签名认证")
